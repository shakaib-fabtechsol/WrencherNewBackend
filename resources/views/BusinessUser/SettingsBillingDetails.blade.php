            ...
            <div class="d-flex align-items-center justify-content-between w-100">
                <div class="">
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <h5 class="mb-0 blu font-j">Billing Details</h5>
                    </div>
                </div>
                <div class="">
            ...
            <div class="right-bottom1">
                <div class="container-fluid h-100">
                    <form action="#" class="">
                        <div class="row mt-3">
                            <div class="col-lg-8">
                                <!-- New Fields: Business Name, Description, Address -->
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        <label for="business_name" class="ps-2 fw-semibold">Business Name</label>
