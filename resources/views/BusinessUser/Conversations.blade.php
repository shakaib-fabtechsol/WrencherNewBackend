                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-start">
                                <h3 class="hding mb-0">
                                    <span class="sky fs-4 fw-medium">Oppurtunities</span>
                                    <i class="fas fa-chevron-right mx-1 fs-6"></i>
                                    <span class="fs-6">Conversations</span>
                                </h3>
                            </div>
                        </div>
                        <div class="col-6">
                                        ...
                                        <div class="person-show">
                                            <div class="d-flex justify-content-between mt-2 chat-person active m-2">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img src="{{ asset('img/customer1.png') }}" alt=""
                                        ...
                                        <div class="border-top p-2">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ps-2 me-2">
                                                        <i class="bi bi-emoji-smile icons-clr"></i>
                                                    </div>
