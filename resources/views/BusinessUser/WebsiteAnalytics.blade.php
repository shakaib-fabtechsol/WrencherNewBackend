                                ...
                                <div class="d-xl-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d-lg-flex justify-content-end align-items-center">
                                        <div class="d-flex justify-content-end">
                                            <button type="button"
                                                class="mbl-100 mt-3 mt-lg-0 rounded-2 px-4 text-nowrap py-2 me-2 bg-sky text-white border-0 btn-sv"
                                                data-bs-toggle="modal" data-bs-target="#callpop">+
                                                Add New Call
                                            </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-6 mt-4">
                                        <div class="h-100 bg-white border-1 rounded-3">
                                            <div
                                                class="p-3 d-flex justify-content-between align-items-center border-bottom border-1">
                                                <p class="font-semi fs-6 mb-0">Profit & Loss</p>
                                                <div class="dropdown">
        ...
        <div class="modal-dialog">
            <div class="modal-content rounded-5">
                ...
                <div class="modal-body">
                    <div class="p-5">
                        <label for="Customer Name" class="font-semi mb-2">Customer Name</label>
                        <input type="text" id="Customer Name" placeholder="Lucas Hood"
                            class="form-control focus-none mb-2">
                        <label for="Phone" class="font-semi mb-2">Phone *</label>
                        <input type="number" id="Phone" placeholder="1234567" required
                            class="form-control focus-none mb-2">
                        <label for="email" class="font-semi mb-2">Email (Optional)</label>
                        <input type="email" id="email" placeholder="awesomaa1@domain.com"
                            class="form-control focus-none mb-2">
                        <label for="address" class="font-semi mb-2">Address (Optional)</label>
                        <input type="text" id="address" placeholder="123 Eve, Rookers Block Las Vegas"
                            class="form-control focus-none mb-2">
                        <label class="font-semi mb-2">What You Are Looking For?</label>
                        <div class="check-box d-sm-flex flex-wrap">
                            <div class="d-flex align-items-center">
                                <input type="checkbox" id="Quote"> <label class="ms-2"
                                    for="Quote">Quote</label>
                            </div>
                            <div class="d-flex align-items-center">
                                <input type="checkbox" class="ms-0 ms-sm-3" id="Schedule an Estimate"> <label
                                    class="ms-2" for="Schedule an Estimate">Schedule an Estimate</label>
                            </div>
                            <div class="d-flex align-items-center">
                                <input type="checkbox" class="ms-0 ms-sm-3" id="Other"> <label class="ms-2"
                                    for="Other">Other</label>
                            </div>
                        </div>
                        <label for="Notes" class="font-semi mb-2">Notes</label>
