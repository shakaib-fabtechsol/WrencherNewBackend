                            ...
                            <div class="stepper-form  mt-3">
                                <div class="step-content-container">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-xxl-4 mb-3">
                                                ...
                                                <div class="d-flex mt-2">
                                                    ...
                                                    <div class="">
                                                        <input type="radio" name="link" id="quote">
                                                        <label for="quote">Link to invoice</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="mb-0 lh-font">This Independent Contractor Agreement (“Agreement”)
                                                is made between <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">with a mailing address of <input type="text"
                                                    name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">City of <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">State of <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">("Client")</p>
                                            <p class="fw-bold text-center my-4">AND</p>
                                            <p class="lh-font mb-0"><input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">
                                                with a principal place of business at<input type="text"
                                                    name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">City of <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                            ...
                                            <p class="lh-font mb-0 mt-3">WHEREAS this Agreement shall be made effective
                                                on the<input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">days of <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">20<input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">.</p>
                                            <p class="mt-3 lh-font mb-0">THE PARTIES AGREE AS FOLLOWS:</p>
                                            <h6 class="fw-bold">1. Services to Be Performed</h6>
                                            <p class="lh-font">Contractor agrees to perform the following
                                                services:<input type="text" name=""
                                            ...
                                            <p class="lh-font">In consideration for the Services to be performed by
                                                Contractor, Client agrees to pay
                                                Contractor in the following manner:<input type="text"
                                                    name=""
                                                    class="border-bottom border-0 bg-transparent border-black "
                                                    id=""><input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black "
                                                ...
                                                submits an invoice to
                                                Client. The invoice should include the following: an invoice number, the
                                                dates covered
                                                by the invoice, a summary of the work performed, and any other
                                    ...
                                    <div class="step-content">
                                        <div class="d-flex align-items-baseline mb-3">
                                            ...
                                            <label for="" class="ms-3">Client shall reimburse Contractor
                                                ...
                                                the Services
                                                performed under this Agreement:<input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id=""> </label>
                                        </div>
                                        <div>
                                    ...
                                    <div class="step-content">
                                        <div class="d-flex align-items-baseline mb-3">
                                            <input type="checkbox">
                                            <label for="" class="ms-3">Automobile liability insurance for
                                                each vehicle
                                                used in the performance of this
                                                ...
                                                <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">combined single limit per occurrence for bodily
                                                injury and
                                                property damage.
                                            </label>
                                        </div>
                                        <div class="d-flex align-items-baseline mb-3">
                                            <input type="checkbox">
                                            <label for="" class="ms-3">Comprehensive or commercial general
                                                liability
                                                insurance coverage in the minimum
                                                amount of <strong>$</strong>
                                                <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">combined single limit, including coverage for bodily
                                                injury, personal injury, broad form property damage, contractual
                                        ...
                                        <p class="ps-sm-4">With reasonable cause, either Client or Contractor may
                                            ...
                                            Agreement at any
                                            time by giving <input type="text" name=""
                                                class="border-bottom border-0 bg-transparent border-black mx-1"
                                                id="">
                                    ...
                                    <div class="step-content">
                                        ...
                                        <div class="d-flex align-items-baseline mb-3">
                                            <input type="checkbox">
                                            <label for="" class="ms-3"> If a dispute arises under this
                                                Agreement, any
                                                party may take the matter to Florida
                                        ...
                                        <div class="d-flex align-items-baseline mb-3">
                                            ...
                                            <label for="" class="ms-3"> If a dispute arises under this
                                                Agreement, the
                                                parties agree to first try to resolve the
                                                dispute with the help of a mutually agreed-upon mediator in
                                                <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">County, State of Florida. Any costs and fees other
                                                than
                                                ...
                                                submit the dispute
                                                to a mutually agreed-upon arbitrator in <input type="text"
                                                    name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1"
                                                    id="">County, State of Florida.
                                        ...
                                        <p class="">Contractor acknowledges that it will be necessary for Client
                                            ...
                                            Services
                                            to Client; and Other (if any): <input type="text" name=""
                                                class="border-bottom border-0 bg-transparent border-black mx-1"
                                                id=""><br>
                                    ...
                                    <div class="step-content">
                                        ...
                                        <div class="d-flex align-items-baseline mb-3">
                                            <input type="checkbox">
                                            <label for="" class="ms-3">There are additional attachments or
                                                addendums to
                                                this Agreement described as:
                                                <input type="text" name=""
                                                    class="border-bottom border-0 w-100 bg-transparent border-black mx-1"
                                                    id="">
                                                <input type="text" name=""
                                                    class="border-bottom border-0 bg-transparent border-black mx-1 w-100"
                                                    id="">
                                            </label>
                                        </div>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-sm-6 mb-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="ms-2">
                                                        <button
                                                            class="bg-lgrey border px-3 py-2 rounded-2">Apply</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="">
                                                        <label for="" class="text-nowrap">Name of
                                                            Company</label>
                                                    </div>
                                                    <div class="w-100 mx-1">
                                                        <input type="text" name=""
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="">
                                                        <label for="" class="text-nowrap"> Title of
                                                            Signer</label>
                                                    </div>
                                                    <div class="w-100 mx-1">
                                                        <input type="text" name=""
