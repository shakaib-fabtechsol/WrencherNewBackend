        ...
        <div class="p-2">
            <div class="right-bottom1">
                <div class="container-fluid h-100">
                    <form action="{{ route('Admin.Packages') }}" class="">
                        <div class="row mt-3">
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        <label for="pkg_name" class="ps-2 fw-semibold">Package Name</label>
                                        <input type="text" id="pkg_name" class="w-100 bg-white border rounded-3 p-2"
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" id="discount" class="w-100 bg-white border rounded-3 p-2"
